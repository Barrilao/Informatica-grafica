...
void _ovni::draw(_modo modo, float r1, float g1, float b1, float r2, float g2, float b2, float grosor){
	glPushMatrix();
		...
		glPushMatrix();
			...
			if(activo[0]==1) vaca.draw(modo,r_s,g_s,b_s,r2,g2,b2,grosor);
			else vaca.draw(modo,r1,g1,b1,r2,g2,b2,grosor);
		glPopMatrix();
		glPushMatrix();
			glRotatef(-giro_ovni,0,1,0);
			if(activo[1]==1) luz.draw(modo,r_s,g_s,b_s,r2,g2,b2,grosor);
			else luz.draw(modo,r1,g1,b1,r2,g2,b2,grosor);
		glPopMatrix();
		glPushMatrix();
			glRotatef(giro_ovni,0,1,0);
			glPushMatrix();
				glTranslatef(0,8,0);
				if(activo[2]==1) superior.draw(modo,r_s,g_s,b_s,r2,g2,b2,grosor);
				else superior.draw(modo,r1,g1,b1,r2,g2,b2,grosor);
			glPopMatrix();
			glPushMatrix();
			if(activo[3]==1) base.draw(modo,r_s,g_s,b_s,r2,g2,b2,grosor);
			...
			glPushMatrix();
				...
				glRotatef(-90,0,1,0);
				if(activo[4]==1) pata.draw(modo,r_s,g_s,b_s,r2,g2,b2,grosor);
				else pata.draw(modo,r1,g1,b1,r2,g2,b2,grosor);
			glPopMatrix();
			glPushMatrix();
				glTranslatef(0,0,19);
				glRotatef(giro_pata,1,0,0);
				glRotatef(90,0,1,0);
				if(activo[5]==1) pata.draw(modo,r_s,g_s,b_s,r2,g2,b2,grosor);
				else pata.draw(modo,r1,g1,b1,r2,g2,b2,grosor);
			glPopMatrix();
			glPushMatrix();
				glTranslatef(19,0,0);
				...
				glRotatef(180,0,1,0);
				if(activo[6]==1) pata.draw(modo,r_s,g_s,b_s,r2,g2,b2,grosor);
				else pata.draw(modo,r1,g1,b1,r2,g2,b2,grosor);
			glPopMatrix();
			glPushMatrix();
				glTranslatef(-19,0,0);
				glRotatef(giro_pata,0,0,1);
				if(activo[7]==1) pata.draw(modo,r_s,g_s,b_s,r2,g2,b2,grosor);
				else pata.draw(modo,r1,g1,b1,r2,g2,b2,grosor);
			glPopMatrix();
		glPopMatrix();
	glPopMatrix();
...
void _ovni::seleccion(float c){
	glPushMatrix();
		...
		glPushMatrix();
			...
			glTranslatef(0,-50,0);
			glRotatef(absorbe_vaca,1,1,1);
 			vaca.draw(SELECT,c,c,c,c,c,c,1);
			c=c+20;
		glPopMatrix();
		glPushMatrix();
			glRotatef(-giro_ovni,0,1,0);
 			luz.draw(SELECT,c,c,c,c,c,c,1);
			c=c+20;
		glPopMatrix();
		glPushMatrix();
			glRotatef(giro_ovni,0,1,0);
			glPushMatrix();
				glTranslatef(0,8,0);
 				superior.draw(SELECT,c,c,c,c,c,c,1);
				c=c+20;
			glPopMatrix();
			glPushMatrix();
			...
			glPushMatrix();
				...
				glRotatef(-giro_pata,1,0,0);
				glRotatef(-90,0,1,0);
				pata.draw(SELECT,c,c,c,c,c,c,1);
				c=c+20;
			glPopMatrix();
			glPushMatrix();
				glTranslatef(0,0,19);
