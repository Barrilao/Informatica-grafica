...
_cubo::_cubo(float tam)
{
	...
	//vertices
	vertices.resize(8);
	vertices[0].x=pos;vertices[0].y=pos;vertices[0].z=tam;
	vertices[1].x=tam;vertices[1].y=pos;vertices[1].z=tam;
	vertices[2].x=tam;vertices[2].y=pos;vertices[2].z=pos;
	vertices[3].x=pos;vertices[3].y=pos;vertices[3].z=pos;

	vertices[4].x=pos;vertices[4].y=tam;vertices[4].z=tam;
	vertices[5].x=tam;vertices[5].y=tam;vertices[5].z=tam;
	vertices[6].x=tam;vertices[6].y=tam;vertices[6].z=pos;
	vertices[7].x=pos;vertices[7].y=tam;vertices[7].z=pos;
