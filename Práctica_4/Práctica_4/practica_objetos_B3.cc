...
void luces(float alfa,float beta)
{
	...
	luz2[] = {0.5,1.0,0.6,1.0},
	pos1[] = {0.0,0.0,30.0,1.0},
	pos2[] = {-20.0,0.0,0.0,1.0}//,
	//brillo2[] = {1.0,0.5,0.5,1.0}
	;
...
switch (toupper(Tecla1)){
	...
	case '5':modo=SOLID_ILLUMINATED_FLAT;glutPostRedisplay();break;
	case '6':modo=SOLID_ILLUMINATED_GOURAUD;glutPostRedisplay();break;
...
switch (Tecla1){
  ...
  case GLUT_KEY_F10:ovni.giro_ovni-=5;break;
	...
	case GLUT_KEY_HOME:beta+=5;break;
	case GLUT_KEY_END:beta-=5;break;
	}
glutPostRedisplay();
}
